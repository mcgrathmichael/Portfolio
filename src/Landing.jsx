...
function Landing() {
  return (
    <div className="px-5 lg:py-12 text-4xl lg:text-8xl md:leading-loose md:px-17 lg:px-24">
      ...
      <section className="flex justify-start lg:justify-center xl:justify-normal gap-16 py-9 md:py-20 text-sm md:text-lg font-bold">
        <div className="flex gap-10 sm:flex-row ">
          <Link
            ...
            offset={-70}
            duration={500}>
            <button className=" hover:ring-2  hover:ease-in-out hover:ring-green ring-offset-1 opacity-75 overflow-hidden p-6 rounded-2xl bg-gradient-to-t from-pink to-purple">
              Check out My Work
            </button>
          </Link>
          <a href={CV} download="Michael McGrath CV">
            <button
              type="button"
              className="opacity-75 hover:transition-all hover:opacity-1 hover:ring-2 overflow-hidden rounded-2xl p-6 bg-gradient-to-t from-green to-purple hover:from-pink hover:to-purple">
              Download My CV
            </button>
          </a>
        </div>
